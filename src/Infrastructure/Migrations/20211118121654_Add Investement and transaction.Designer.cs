...
namespace BlazorHero.CleanArchitecture.Infrastructure.Migrations
{
    ...
    [Migration("20211118121654_Add Investement and transaction")]
    partial class AddInvestementandtransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Finance.FinanceAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsInvestmentAccount")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Finance.Investment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<double?>("DividendReturnPercentage")
                        .HasColumnType("float");

                    b.Property<string>("EmmissionNo")
                        .HasMaxLength(100)
                    ...
                    b.Property<DateTime>("InterestClaimSinceDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("InvestmentEndDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal>("NominalValueOfAnInvestment")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<double?>("TotalReturnPercentage")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("No", "FinanceAccountId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Finance.Transaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Finance.Investment", b =>
                {
                    b.HasOne("BlazorHero.CleanArchitecture.Domain.Entities.Finance.FinanceAccount", "FinanceAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Finance.Transaction", b =>
                {
                    b.HasOne("BlazorHero.CleanArchitecture.Domain.Entities.Finance.FinanceAccount", "CounterAccount")
                        .WithMany()
                    ...
                    b.HasOne("BlazorHero.CleanArchitecture.Domain.Entities.Finance.Investment", "Investment")
                        .WithMany()
